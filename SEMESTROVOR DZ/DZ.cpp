...
//ВХОДНЫЕ ДАННЫЕ
const double MASS0 = 13900.0;
const double S_WING = 70.0;
const int ENGINE_COUNT = 3;
const double THRUST_PERCENT = 110.0;

const double H_START = 500.0;
const double H_FINISH = 6200.0;
const double V_START_KMH = 270.0;
const double V_FINISH_KMH = 770.0;
...
int main() {
    ...
    cout << "\n=================================================\n";
    cout << "   OPTIMIZACIA TRAEKTORII YAK-40 (Variant 13)\n";
    cout << "=================================================\n";
    cout << "Samolyet: YAK-40 (massa " << MASS0 / 1000.0 << " t)\n";
    cout << "Dvigateli: 3 x AI-25 (" << THRUST_PERCENT << "% nominala)\n";
